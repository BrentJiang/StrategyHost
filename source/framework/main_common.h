...
// go through StrategyHostCommonBase directly.
class StrategyHostCommon {
public:
  StrategyHostCommon(int argc, const char* const* argv);
  ...
  // responsibility of the caller.
  void adminRequest(absl::string_view path_and_query, absl::string_view method,
                    const StrategyHostCommonBase::AdminRequestFn& handler) {
